...
async def fetch_info(replied_user, event):
    ...
    caption = f"<b>⚙ INFO UTENTE ⚙</b>\n\n<b>ðﾟﾑﾨðﾟﾏﾻ‍ðﾟﾔﾧ Nome:</b> {first_name}\n<b>ðﾟﾤﾵðﾟﾏﾻ Cognome:</b> {last_name}\n<b>ðﾟﾌﾐ Username:</b> {username}\n<b>ðﾟﾆﾔ ID:</b> <code>{user_id}</code>\n<b>ðﾟﾤﾖ Bot:</b> {user_is_bot}\n<b>ðﾟﾒﾬ Chat In Comune:</b> {common_chat}\n<b>ðﾟﾔﾗ PermaLink:</b> <a href=\"tg://user?id={user_id}\">{first_name}</a>\n<b>ðﾟﾓﾕ Bio:</b> <code>{user_bio}</code>"
